        ...
        <table class="table table-striped table-sm">
          ...
          <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  <img src="<?php echo e(Storage::url($property->image)); ?>" alt="<?php echo e($property->name); ?>" class="img-fluid col-sm-5">
                </td>
                <td>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/projectAldi/TTIS-CSIRT/resources/views/dashboard/properties/index.blade.php ENDPATH**/ ?>