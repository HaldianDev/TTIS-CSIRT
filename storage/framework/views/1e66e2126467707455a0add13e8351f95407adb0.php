                            ...
                            <div class="modern-card cyber-border w-100">
                                <div class="card-image mt-2">
                                    <!-- <img src="<?php echo e(asset('storage/' . $post->image)); ?>" alt="<?php echo e($post->category->name); ?>">
                                     ...
                                     <img src="<?php echo e($post->image ? asset('storage/' . $post->image) : asset('img/logo.png')); ?>"
                                        alt="<?php echo e($post->category->name); ?>"
                                        class="<?php echo e($post->image ? '' : 'd-block mx-auto mt-1'); ?>"
                                        style="<?php echo e($post->image ? '' : 'width: 50%; height: 100%;'); ?>">
                                </div>
                ...
                <div class="bg-gradient-dark rounded-4 p-5 p-xl-6 shadow-lg text-center position-relative overflow-hidden encryption-section">
                    ...
                    <div class="row justify-content-center">
                            <div class="col-12 col-md-10 col-lg-8 text-center position-relative px-3">
                                ...
                                <?php if($keys->first()): ?>
                                    <a href="<?php echo e(asset('storage/public-key/' . $keys->first()->name)); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/projectAldi/TTIS/resources/views/home.blade.php ENDPATH**/ ?>