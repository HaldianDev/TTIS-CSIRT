    ...
    <div class="container">
      <a class="navbar-brand" href="/">
          <?php $__currentLoopData = $properties->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <img class="logo img-fluid" src="<?php echo e(Storage::disk('s3')->url($property->image)); ?>" alt="<?php echo e($property->property); ?>">
...
<!-- End Navigation Bar --><?php /**PATH /home/a/projectAldi/TTIS-CSIRT/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>