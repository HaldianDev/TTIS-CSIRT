        ...
        <table class="table table-striped table-sm">
          ...
          <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td><a href="<?php echo e(Storage::disk('s3')->url($key->path)); ?>" target="_blank"><?php echo e($key->name); ?></a></td>
                <td>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/projectAldi/TTIS-CSIRT/resources/views/dashboard/keys/index.blade.php ENDPATH**/ ?>